...
def create_app(
    emby_host: str,
    pin_rules: Optional[List[Tuple[str, str]]] = None,
    ...
    async def _read_request_body_safe(request: Request) -> Optional[bytes]:
        """
    ...
    def _inject_scripts_into_html(html: str) -> Optional[str]:
        """
    ...
    ) -> Union[RedirectResponse, StreamingResponse, JSONResponse, Response]:
        """
    ...
    async def _try_media_response(
        item_id: str, api_key: Optional[str], request: Request
    ...
    async def _reverse_proxy_html_inject(
        request: Request,
    ...
    def _patch_js_response_headers(
        resp: HttpxResponse, extra: Optional[Dict[str, str]] = None
    ) -> Dict[str, str]:
        """
    ...
    async def _patch_basehtmlplayer_js(
        request: Request,
    ) -> Union[JSONResponse, Response]:
        """
    ...
    async def _patch_plugin_js(request: Request) -> Union[JSONResponse, Response]:
        """
